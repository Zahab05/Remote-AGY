...
Workflow [`.github/workflows/check_tasks.yml`](.github/workflows/check_tasks.yml) telah disiapkan agar GitHub secara mandiri memeriksa tugas portal kampus setiap **30 menit**.
